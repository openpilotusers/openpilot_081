  ...
  if not usestockscc and not aebcmdact:
    if enabled:
      ...
      if standstill:
        ...
        values["ComfortBandUpper"] = 0.24 # stock usually is 0 but sometimes uses higher values
        values["ComfortBandLower"] = 0.24 # stock usually is 0 but sometimes uses higher values
