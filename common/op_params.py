...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {'camera_offset': Param(0.06, VT.number, 'Your camera offset to use in lane_planner.py', live=True),
                        ...
                        'global_df_mod': Param(1.2, VT.number, 'The multiplier for the current distance used by dynamic follow. The range is limited from 0.85 to 1.5\n'
                                                               'Smaller values will get you closer, larger will get you farther\n'
                                                               'This is multiplied by any profile that\'s active. Set to 1. to disable', live=True),
                        'min_TR': Param(1.1, VT.number, 'The minimum allowed following distance in seconds. Default is 0.9 seconds.\n'
